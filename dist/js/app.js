(() => {
    ...
    function initSliders() {
        if (document.querySelector(".get__slider")) {
            let menu = [ "One week", "Month", "Year" ];
            new core(".get__slider", {
        ...
        if (document.querySelector(".feel__slider")) {
            let menu = [ "One week", "Individual", "Year" ];
            new core(".feel__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        if (document.querySelector(".picture__slider")) new core(".picture__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    if (switch_container) {
        ...
        switch_container.addEventListener("click", (e => {
            if ("BUTTON" == e.target.nodeName) if (e.target.classList.contains("loginjs")) {
                e.target.classList.add("button-bg", "inspire__btn-bg", "button-active");
                e.target.classList.remove("unactive-login");
                signinjs.classList.remove("button-bg", "inspire__btn-bg", "active-signin");
                signinjs.classList.add("button-unactive");
                select_role_admin.style.display = "none";
                login_bottom_text.style.display = "flex";
                signin_bottom_text.style.display = "none";
            } else {
                loginjs.classList.remove("button-bg", "inspire__btn-bg", "button-active");
                loginjs.classList.add("unactive-login");
                signinjs.classList.add("button-bg", "inspire__btn-bg", "active-signin");
                signinjs.classList.remove("button-unactive");
        ...
        openAdminPage.addEventListener("click", (event => {
            selectRoleAdmin.forEach((e => {
                if (e.checked) event.target.setAttribute("href", e.value);
            }));
        }));
    }
    const messagerSwiper = document.querySelector(".messagerSwiper");
    if (messagerSwiper) new Swiper(".messagerSwiper", {
        loop: true,
        spaceBetween: 28,
        breakpoints: {
            0: {
    ...
    if (adminMenuIcon) adminMenuIcon.addEventListener("click", (() => {
        modalMenuAdmin.classList.toggle("modal-menu-admin-open");
        if (modalMenuAdmin.classList.contains("modal-menu-admin-open")) adminForOwner.classList.add("myClass-blur"); else adminForOwner.classList.remove("myClass-blur");
    }));
